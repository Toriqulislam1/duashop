...
class WebController extends Controller
{
    ...
    {
//        $top_banners = Banner::where('banner_type', '=', 'Top Banner')->where('published',1)->inRandomOrder()->limit(1)->get();
//        dd($top_banners);
    ...
    public function productFile($id)
    {
        ...
        $file = "{{asset('public/assets/front-end/pdf/$product->file')}}";
        return response()->json($product);
    }

    public function file($file)
    {
        $product = Product::where('file','=',$file)->first();
        $path = 'public/assets/front-end/pdf' . '/' . $file;
    ...
    public function order_note(Request $request)
    {
        ...
        if ($request->has('customer_delivery_date')) {
            session::put('customer_delivery_date', $request->customer_delivery_date);
        }
        return response()->json();
    }
