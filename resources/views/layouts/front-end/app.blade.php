...
@endif
    <script>
            ...
            if (isMobile) {
                window.onload = function() {
                    var sp2 = new SuperPlaceholder({
                        placeholders: ["Search by Authors()","Search by Publisher()", "Search by Books()"],
                        preText: " ",
                        stay: 1000,
                        speed: 100,
                        element: '#dynamic'
        ...
        //     $('#dynamic').attr("placeholder", "placeholder text");
        //
        // });
        // $( '.dynamic-placeholder2' ).ready(function() {
        //     // $('#dynamic-placeholder').attr("placeholder", "placeholder text");
        //
        // });
    </script>
