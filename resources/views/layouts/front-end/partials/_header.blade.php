        ...
        <div class="container">
            <div>
                ...
                @foreach($top_banners as $key=>$banner)
                    <a href="{{$banner->url}}"><img style="width: 1500px; height: 45px" onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'" src="{{asset('storage/app/public/banner')}}/{{$banner['photo']}}"></a>
                @endforeach
{{--                <img style="width: 1500px; height: 45px" src="{{asset('public/assets/front-end/img/top.jpg')}}" alt="">--}}
            </div>
            ...
            <div class="container ">
                ...
                <div class="input-group-overlay d-none d-md-block mx-4"
                    ...
                    <form action="{{route('products')}}" type="submit" class="search_form">
                        <input class="form-control appended-form-control search-bar-input dynamic-placeholder2" type="text"
                               autocomplete="off"
