    ...
    <section class="col-lg-8">
        ...
        <form  method="get">
            <div class="form-group">
                <div class="row">
                    <div class="col-12">
                        <label for="phoneLabel" class="form-label input-label">Delivery Date<span class="input-label-secondary">({{\App\CPU\translate('Optional')}})</span></label>
                        <input type="date" class="form-control" id="customer_delivery_date" name="customer_delivery_date">
                    </div>
                    <div class="col-12">
...
<script>
    function checkout(){
        ...
        let customer_delivery_date = $('#customer_delivery_date').val();
