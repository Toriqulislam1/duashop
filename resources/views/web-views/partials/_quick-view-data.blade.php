    ...
    <div class="row ">
        ...
        <div class="col-lg-6 col-md-6 mt-md-0 mt-sm-3">
            ...
            <div class="col-lg-6 col-md-6 mt-md-0 mt-sm-3">
                <div class="table-responsive" style="max-height: 515px; padding: 0px;">
                    <div class="d-flex">
                        @php($active_prodcuts = \App\Model\Product::where('featured','=',1)->inRandomOrder()->limit(1)->get())
                        @foreach ($active_prodcuts as $key => $photo)
                            <div class="cz-thumblist">
{{--                                <img style=""--}}
{{--                                     src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$photo['thumbnail']}}"--}}
{{--                                     onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"--}}
{{--                                     alt="">--}}
                                    ...
                                    <div class=" inline_product clickable d-flex justify-content-center"
                                        ...
                                        @if($photo->discount > 0)
                                            <div class="d-flex" style="left:7px;top:2px;position: absolute">
                                                ...
                                                @if ($photo->discount_type == 'percent')
                                                        {{round($photo->discount,$decimal_point_settings)}}%
                                                    @elseif($photo->discount_type =='flat')
                                                        {{\App\CPU\Helpers::currency_converter($photo->discount)}}
                                                    @endif
                                        ...
                                        <div class="d-flex d-block" style="cursor: pointer;">
                                            <a href="{{route('product',$photo->slug)}}">
                                        ...
                                        <div class="rating-show justify-content-between text-center">
                                            <span class="d-inline-block font-size-sm text-body">
                                                @for($inc=0;$inc<5;$inc++)
                                                    ...
                                                    @endif
                                                @endfor
                                                <label class="badge-style">( {{$photo->reviews_count}} )</label>
                                            </span>
                                        </div>
                                            ...
                                            <div class="product-price text-center">
                                                @if($photo->discount > 0)
                                                    <strike style="font-size: 12px!important;color: #E96A6A!important;">
                                                        {{\App\CPU\Helpers::currency_converter($photo->unit_price)}}
                                                    </strike><br>
                                                @endif
                                                <span class="text-accent">
                                                    {{\App\CPU\Helpers::currency_converter(
                                                        $photo->unit_price-(\App\CPU\Helpers::get_product_discount($photo,$photo->unit_price))
                                                    )}}
                                                </span>
                                            </div>
                                        </div>
