                            ...
                            <tr class="order_table_tr" style="background: {{$web_config['primary_color']}}">
                                ...
                                <td class="order_table_td">
                                    <div class="order_table_info_div">
                                        ...
                                        <div class="order_table_info_div_2">
                                            <span class="spanTr"> {{date('d M, Y',strtotime($order->created_at))}} </span>
                                        </div>
                                        @if($order->customer_delivery_date)
                                            <div class="order_table_info_div_1 py-2">
                                                <span class="d-block spandHeadO">{{\App\CPU\translate('customer_delivery_date')}}: </span>
                                            </div>
                                            <div class="order_table_info_div_2">
                                                <span class="spanTr"> {{date('d M, Y',strtotime($order->customer_delivery_date))}} </span>
                                            </div>
                                        @endif
